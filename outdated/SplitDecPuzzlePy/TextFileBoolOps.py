...
if __name__ == '__main__':
    large_input = '/Users/samtaylor/Downloads/scrabble-master/dictionary.txt'
    small_input = '/Users/samtaylor/Documents/SplitDecPuzzleGo/google-10000-english-usa-no-swears.txt'
    intersection_output = '/Users/samtaylor/Documents/SplitDecPuzzleGo/TextFiles/UsableDictionary.txt'
    union_output = '/Users/samtaylor/Documents/SplitDecPuzzleGo/TextFiles/ReferenceDictionary.txt'
    tfbo = TextFileBoolOps(large_input, small_input)
    # prune files based on minimum word length
    tfbo.small = [word for word in tfbo.small if len(word) >= 3]
    tfbo.large = [word for word in tfbo.large if len(word) >= 3]
